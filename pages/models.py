...
class Page(models.Model):
	...
	jumbotron_text_color  = models.CharField(max_length=7, default="#000000", validators=[])
	jumbotron_bg_color    = models.CharField(max_length=7, default="#eeeeee", validators=[])
