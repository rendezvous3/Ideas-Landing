...
class Page(models.Model):
	...
	jubmotron_text_color  = models.CharField(max_length=7, default="#000000", validators=[])
	jubmotron_bg_color    = models.CharField(max_length=7, default="#eeeeee", validators=[])
